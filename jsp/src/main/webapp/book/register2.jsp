...
<script>
	window.onload = function(){
		...
		//익명의 함수를 작성할 수 있고, 이미 작성된 함수의 이름을 넘겨줄 수도 있다.
		//함수의 이름을 넣어줄 때에는 함수이름 뒤에 ()를 붙이면 안됩니다ㅣ.
		//함수이름(): 함수를 실행하라는 의미
	...
	function validationCheck(){
		...
		if(id.value.length > 10) {
			alter('아이디의 길이는 10자를 초과할 수 없습니다.');
			id.focus();
			return false;
		}
    	...
    	let email_reg = /^[\w\.-]+@[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}$/;
	...
	function getByteLength(str) {
		//TextEncoder 객체 생성 (UTF-8))
		var encoder = new TextEncoder('utf-8');
		var encoder = encoder.encode(str);
