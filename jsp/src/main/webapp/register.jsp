...
<script type="text/javascript">
	window.onload = function(){
		//var 전역변수 / let 지역변수
		//let document.querySelect("#submitBtn");
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" name="regForm" action = "/regProcess">
                                ...
                                <input type="submit" id="submitBtn" class="btn btn-primary btn-user btn-block" value="회원가입"
                                >
